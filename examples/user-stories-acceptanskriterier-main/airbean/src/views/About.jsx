...
function About() {
    return (
        <main className="about">
            <NavIcon /> 
            <h1>Vårt Kaffe</h1>
            <p className="ingress">Pumpkin spice mug, barista cup, sit macchiato, kopi-luwak, doppio, grounds dripper, crema, strong whipped, variety extra iced id lungo half and half mazagran. Pumpkin spice.</p>
